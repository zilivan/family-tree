...
const steps = [
  {
    ...
    description: "Зарегистрируйтесь и добавьте информацию о себе",
  },
  {
    icon: Users,
    title: "Добавьте родственников",
    description: "Укажите родителей, детей, братьев и сестёр",
  },
  {
    icon: Link2,
    title: "Постройте связи",
    description: "Соедините членов семьи между собой",
  },
  {
    icon: Share2,
    title: "Делитесь историей",
    description: "Пригласите родственников дополнить дерево",
  },
];
