...
export default function FamilyViewPage({
  ...
  const personId =
    searchParams.get("personId") === "delete_person"
      ? null
      : searchParams.get("personId") || userPersonId;
  ...
  const refetchAll = (deletePersonId?: string) => {
    if (deletePersonId === userPersonId) {
      setSearchParams({ personId: "delete_person" });
      return;
    }
    if (deletePersonId === personId) {
      setSearchParams({ personId: userPersonId });
      return;
    }
